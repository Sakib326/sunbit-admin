...
namespace App\Filament\Resources\ZellaResource\RelationManagers;
...
class UpazillasRelationManager extends RelationManager
{
    protected static string $relationship = 'upazillas';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('code')
                    ->maxLength(255)
                    ->helperText('Optional short code for the upazilla'),
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('No Upazillas Added')
            ->emptyStateDescription('Add upazillas to further organize locations in this zella.')
